...
import MethodologyImage from "../src/assets/images/methodology.jpeg";
import CoachImage from '../src/assets/images/coach.jpeg';
        ...
        <main>
            <section className="section section-main">
                <div className="section-wrapper main-wrapper">
                    ...
                    <button className="button-orange main-button">Получить консультацию</button>
                </div>
            </section>
            ...
            <section className="section section-methodology">
                <div className="methodology-wrap">
                    <Image src={MethodologyImage} width={750} height={750} alt="trainer picture"/>
                        ...
                        {DIRECTIONS.map(({ direction, items }, i) => (
                            ...
                            >
                                ...
                                <ul className="directions-item">
                                    {items.map((item) => (
                                        <li className="direction-item" key={item}>
                                            {item}
                                        </li>
                                    ))}
                                </ul>
            ...
            <section className="sections section-coach">
                ...
                <Image src={CoachImage} height={710} width={710} alt="coach" />
            </section>
            ...
            <section className="section section-schedule" id="schedule">
                ...
                <div className="schedule-wrapper">
                    <Image src={ScheduleImage} height={473} width={680} alt="hockey field" />
